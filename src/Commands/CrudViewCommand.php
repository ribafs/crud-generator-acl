<?php
namespace Ribafs\CrudGeneratorAcl\Commands;
...
class CrudViewCommand extends Command
{
    ...
    public function __construct()
    {
        ...
        if (config('crudgeneratoracl.view_columns_number')) {
            $this
                ->defaultColumnsToShow = config('crudgeneratoracl.view_columns_number');
        }

        $this->delimiter = config('crudgeneratoracl.custom_delimiter')
            ? config('crudgeneratoracl.custom_delimiter')
            : ['%%', '%%'];
    }
    ...
    public function handle()
    {
        ...
        $this->viewDirectoryPath = config('crudgeneratoracl.custom_template')
            ? config('crudgeneratoracl.path') . 'views/' . $formHelper . '/'
    ...
    {
        $dynamicViewTemplate = config('crudgeneratoracl.dynamic_view_template')
            ? config('crudgeneratoracl.dynamic_view_template')
